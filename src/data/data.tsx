...
export const portfolioItems: PortfolioItem[] = [
  ...
  {
    title: 'PaySync: Simplify & Automate Your Finances',
    description: 'A user-friendly personal finance app designed to streamline budgeting, track expenses in real-time, and automate bill payments. Offers intuitive dashboards, spending insights, and goal-setting tools to empower users to take control of their financial health effortlessly.',
